import{_ as t,p as c,f as p,h as o,M as s,q as n,S as e,P as a}from"./vue-router.esm-bundler-952984cf.js";const h={components:{}},i={class:"varlet-site-doc"},r=s("h1",null,"海拔效果",-1),j=s("div",{class:"card"},[s("h3",null,"介绍"),s("p",null,[a("组件库提供了基于 "),s("code",null,"Material"),a(" 规范的阴影海拔效果，用来表现元素的立体感。")])],-1),d={class:"card"},_=s("h3",null,"引入样式",-1),m=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),a(),s("span",{class:"hljs-string"},"'@eyelet/ui/es/styles/elevation.css'"),a(`;
`)])],-1),u={class:"card"},g=s("h3",null,"基本使用",-1),v=s("p",null,[a("阴影程度划分为 "),s("code",null,"0-24"),a(" 个等级，等级越高海拔越高。")],-1),x=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
 `),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"zm-space"),a(),s("span",{class:"hljs-attr"},"class"),a("="),s("span",{class:"hljs-string"},'"elevation-example-list"'),a(),s("span",{class:"hljs-attr"},":size"),a("="),s("span",{class:"hljs-string"},'"[16, 16]"'),a(">")]),a(`
 ...
 `),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"zm-space"),a(">")]),a(`
...
`)])],-1);function f(b,y,w,$,k,z){const l=c("var-site-code-example");return p(),o("div",i,[r,j,s("div",d,[_,n(l,{"playground-ignore":""},{default:e(()=>[m]),_:1})]),s("div",u,[g,v,n(l,null,{default:e(()=>[x]),_:1})])])}const B=t(h,[["render",f]]);export{B as default};
