...
`)])],-1),m=s("p",null,[a("注入组件库推荐的 "),s("code",null,"文字颜色"),a(" 和 "),s("code",null,"背景颜色"),a(" 变量来控制整体颜色。")],-1),g=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-selector-tag"},"body"),a(` {
	`),s("span",{class:"hljs-attribute"},"transition"),a(": background-color "),s("span",{class:"hljs-number"},"0.25s"),a(", color "),s("span",{class:"hljs-number"},"0.25s"),a(`;
...
`)])],-1);function v(b,f,k,y,T,x){const l=c("var-site-code-example");return o(),r("div",h,[i,d,s("div",u,[j,n(l,{"playground-ignore":""},{default:t(()=>[_]),_:1}),m,n(l,{"playground-ignore":""},{default:t(()=>[g]),_:1})])])}const N=e(p,[["render",v]]);export{N as default};
