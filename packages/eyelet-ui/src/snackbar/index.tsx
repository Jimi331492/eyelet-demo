...
import ZmSnackbar from './Snackbar.vue';
...
Snackbar.install = function (app: App) {
	app.component(ZmSnackbar.name, ZmSnackbar);
};
...
ZmSnackbar.install = function (app: App) {
	app.component(ZmSnackbar.name, ZmSnackbar);
};

export { props as snackbarProps } from './props';

export const _SnackbarComponent = ZmSnackbar;
